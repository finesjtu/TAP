...
class TargetArgMinPVP(PVP):
    VERBALIZER_A = {
        "Argument_against": ['wrong', 'problem', 'one', 'example', 'effect', '18', 'point', '17', 'needed', 'know',
                             'expressed', 'forward', 'begins', 'around'],
        "Argument_for": ['Right', 'limit', 'educational', 'last', 'including', 'order', '23', 'given', 'funding',
                         'start', 'course', 'days', 'stop', 'correct'],
        "NoArgument": ['none']
    ...
    def verbalize(self, label) -> List[str]:
        if self.pattern_id == 0 or self.pattern_id == 1:
            # print(label)
            return TargetArgMinPVP.VERBALIZER_A[label]
        return TargetArgMinPVP.VERBALIZER_B[label]
...
PVPS = {
    ...
    "AT2016t6": Semeval2016t6PVP,
    "CC2016t6": Semeval2016t6PVP,
    "FM2016t6": Semeval2016t6PVP,
    "HC2016t6": Semeval2016t6PVP,
    "LA2016t6": Semeval2016t6PVP,
    'argmin': TargetArgMinPVP,
    "ABargmin": TargetArgMinPVP,
    "CLargmin": TargetArgMinPVP,
    "DPargmin": TargetArgMinPVP,
    "GCargmin": TargetArgMinPVP,
    "MLargmin": TargetArgMinPVP,
    "MWargmin": TargetArgMinPVP,
    "NEargmin": TargetArgMinPVP,
    "SUargmin": TargetArgMinPVP,
